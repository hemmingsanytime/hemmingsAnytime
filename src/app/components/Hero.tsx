      ...
      <div className="max-w-7xl mx-auto relative w-full">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 w-full sm:w-auto justify-center">
            ...
            <a
              href="#services"
              className="bg-[#f7f9fc] flex items-center justify-center px-8 lg:px-10 py-4 lg:py-5 rounded-xl hover:bg-white hover:scale-[1.02] hover:shadow-xl transition-all shadow-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1e4f8a]"
            >
              <span className="font-medium text-[#1e4f8a] text-lg lg:text-lg whitespace-nowrap">
                Explore Services
              </span>
            </a>
          </div>
