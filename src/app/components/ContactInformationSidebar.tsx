    ...
    return <div className="relative lg:w-2/5 overflow-hidden p-12 text-white">
        ...
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-base font-bold">Brighton · Hastings · Eastbourne</p>
                <p className="text-base font-bold">Hove · Lewes · Haywards Heath</p>
                <p className="text-base font-bold">Bexhill · Seaford</p>
            </div>
            </div>
        </div>
